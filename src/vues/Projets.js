        ...
        <li onClick={() => toggleDisplayMore(1)} className="more-info">
          ...
          {isDisplayingMore[1] && (
            <div>
              ...
              d'apprendre avec des QCM ou des questions libres, mais également la possibilité de créer des questions
              ainsi qu'un forum afin de discuter sur des sujets médicaux. J'ai contribué à la gamification du projet
              ainsi qu'à la gestion du projet en lui-même.
            </div>
          )}
        </li>
        ...
        <li onClick={() => toggleDisplayMore(2)} className="more-info">
          ...
          {isDisplayingMore[2] && (
            <div>
              ...
              planifiée, assignée et assistée au suivi et validation des tâches. Pour moi le bien-être de mon équipe
              était essentiel, pour cela j'ai énormément communiqué avec eux dans un esprit positif.
            </div>
          )}
        </li>
        ...
        <li onClick={() => toggleDisplayMore(3)} className="more-info">
          ...
          {isDisplayingMore[3] && (
            <div>
              ...
              graphiques, mais j'ai également pris en charge la formation et le suivi les stagiaires.
            </div>
          )}
        </li>
      </ul>
